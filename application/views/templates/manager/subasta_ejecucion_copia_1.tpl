                                    ...
                                    <div class="box-subastall">
                                        <div class="box-subhead">
                                            <div class="box-subheadata">
                                                <p class="offer-user"><strong id="misofertas">ADMINISTRADOR</strong></p>
                                            </div>
                                        </div>
                                        <section class="box-contenth2">
                                            <div class="box-hd2-sect">
                                                <div class="box-hd2-actionlive">
                                                    <div class="box-hd2-type"><i class="fa fa-lock"></i></div>
                                        ...
                                        <section class="box-secflex1">
                                            <div class="room-seleft50">
                                                <div class="room-flexblock room-flexbpad">
                                                    <h1 class="room-flextit1">Historial de Posiciones</h1>
                                                    <div class="room-flexgal1">
                                            ...
                                            <div class="room-seleft50">
                                                <div class="room-flexblock room-flexbpad">
                                                    <h1 class="room-flextit1">Historial de Pujas</h1>
                                                    <div class="room-flexgal1">
                                        ...
                                        <section class="box-secontentx1 box-secto2">
                                            <div class="room-left">
                                                <div class="room-auction-live">
                                                    ...
                                                    <div class="room-user row-table-1">
                                                        ...
                                                        <div class="auction-content">
                                                            ...
                                                            <div class="auction-message">
                                                                <div class="message-auction-counter">
                                                                    ...
                                                                    <p class="info-auction-text"><strong>¡Bienvenido a la sala de ofertas!</strong><br>La subasta en vivo inicia en:</p>
