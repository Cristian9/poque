                            ...
                            <div class="box-subastall">
                                <div class="box-subhead">
                                    <div class="box-subheadata">
                                        ...
                                        {*
                                        <p class="offer-user">
                                            <i class="fa fa-money"></i><span>Mis Ofertas: </span><strong id="misofertas">8</strong>
                                        </p>
                                        *}
                                    </div>
                                    {*
                                    <div class="box-subheadata-righ">
                                        <div class="available">
                                            <p class="data-room-title">Mi última oferta</p>
                                            <p class="available-content">
                                                <i class="fa fa-money"></i><strong>($100)</strong>
                                            </p>
                                        </div>
                                    </div>
                                    *}
                                ...
                                <section class="box-secontentx1">
                                    ...
                                    <div class="room-right">
                                            ...
                                            <div class="auction-room">
                                                <div class="auction-content">
                                                    <ul class="message-events">
                                                        ...
                                                        {* {{l.proveedor_id === $proveedor.id ? 'ofertRobot' : 'ofertUser'}} *}
                                                        {literal}
                                        ...
                                        <form class="bform" action="{$get_url}ofertar" method="post">
